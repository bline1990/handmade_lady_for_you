            ...
            <div className="max-w-5xl mx-auto bg-white/30 p-4 rounded-xl">
              ...
              <div className="flex justify-center gap-4 pt-13 md:pt-15">
                ...
                <Link
                  ...
                  target="_blank"
                  className="border-2 border-[#9b7e3c] text-sm sm:text-base text-center text-[#2A1F14] px-6 py-3 rounded-lg hover:bg-[#D6A354]/20 transition active:bg-[#6e5424] active:scale-95"
                >
                  INSTAGRAM
                </Link>
              </div>
